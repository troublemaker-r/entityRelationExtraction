...
import sys
import json
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../pytorch_pretrained_bert")))
...
class Model_data_preparation(object):
    ...
    def __init__(self, RAW_DATA_INPUT_DIR="raw_data", DATA_OUTPUT_DIR="classfication_data",
        ...
        self.bert_tokenizer = tokenization.BertTokenizer(vocab_file=self.get_vocab_file_path(vocab_file_path),
    ...
    def get_vocab_file_path(self, vocab_file_path):
        vocab_file_path = os.path.join(
            os.path.abspath(os.path.join(os.path.dirname(__file__), "../../model")), vocab_file_path)
